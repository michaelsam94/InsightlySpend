...
android {
    namespace = "com.michael.insightlyspend"
    compileSdk {
        version = release(36)
    }

    defaultConfig {
        applicationId = "com.michael.insightlyspend"
        minSdk = 24
        targetSdk = 36
        versionCode = 2
        versionName = "1.0.1"
...
dependencies {
    ...
    // LiteRT (not org.tensorflow:tensorflow-lite): Play-compatible 16 KB ELF alignment for .so files
